...
if (isset($_POST['ogrencilistele'])) {
  ?>
<table class="table-bordered table-striped " style="background-color:#c8c8c8; width: 600px;">
...
if ( $query->rowCount() ){
     foreach( $query as $row ){
          print "<tr><td>".$row['ogrenci_no']."</td><td>".$row['ogrenci_adi']."</td><td>".$row['ogrenci_bolumu']."</td><td><a href='ogrenciguncelle.php?id=".$row['id']."' class='btn btn-sm btn-success'>Güncelle</a></td><td><a href='ogrencisil.php?id=".$row['id']."' class='btn btn-sm btn-danger'> SİL </a></td><td><a href='notekle.php?id=".$row['id']."' class='btn btn-sm btn-primary'>Not İşlemleri</td><tr>";
     }
}
